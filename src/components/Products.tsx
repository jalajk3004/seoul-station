    ...
    return (
        <section id="products" className="relative h-[80vh] min-h-[600px] flex items-center justify-center text-center overflow-hidden">
            ...
            <div className="relative z-10 px-4 max-w-3xl mx-auto text-white space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 max-w-3xl mx-auto mb-8 text-lg font-medium text-cafe-light-beige">
                ...
                <div className="bg-cafe-dark-yellow/90 backdrop-blur-md px-6 py-3 rounded-full inline-block mb-8 border border-white/20 shadow-lg">
                    <p className="text-white font-semibold flex items-center gap-2">
                        <span className="text-xl">💰</span>
                        <span>Approx. ₹600 – ₹1,000 for two people</span>
                    </p>
                </div>
